import{_ as e}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as t,o as p,c as o,b as n,d as s,e as i,a as c}from"./app-qSMjXEym.js";const l={},u=n("h1",{id:"longest-substring-without-repeating-characters",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#longest-substring-without-repeating-characters","aria-hidden":"true"},"#"),s(" longest-substring-without-repeating-characters")],-1),r={href:"https://leetcode.cn/problems/longest-substring-without-repeating-characters/",target:"_blank",rel:"noopener noreferrer"},d=c(`<p>给定一个字符串 s ，请你找出其中不含有重复字符的 最长子串 的长度。</p><div class="hint-container tip"><p class="hint-container-title">示例</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>示例 1:

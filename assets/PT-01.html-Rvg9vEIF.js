import{_ as e}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as t,o as p,c,b as n,e as s,d as o,a as i}from"./app-KBOBa-TU.js";const l={},r=n("h1",{id:"two-sum",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#two-sum","aria-hidden":"true"},"#"),s(" two-sum")],-1),u={href:"https://leetcode.cn/problems/two-sum/",target:"_blank",rel:"noopener noreferrer"},d=i(`<p>给定一个整数数组 nums 和一个整数目标值 target，请你在该数组中找出 和为目标值 target  的那 两个 整数，并返回它们的数组下标。</p><p>你可以假设每种输入只会对应一个答案。但是，数组中同一个元素在答案里不能重复出现。</p><p>你可以按任意顺序返回答案。</p><div class="hint-container tip"><p class="hint-container-title">示例</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>示例 1：
